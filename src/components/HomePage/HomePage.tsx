              ...
              <Box pt={1}>
                ...
                <Box pt={6}>
                  ...
                  <Text fontSize={'sm'} pt={1}>
                    The game itself is turn based and requires 2 players. Player
                    1 chooses a cat that they like (or not), Player 2 has to
                    guess which cat has Player 1 chosen. If the guess is
                    correct, Player 2 wins.
                  </Text>
                </Box>
                <Box pt={6}>
                      ...
                      <AccordionPanel pl={'0'}>
                        <Box>
                          ...
                          <Text fontSize={'sm'} pt={1}>
                            ...
                            is translated into a numerical secret used as an
                            input into a zero-knowledge circuit (= the
                            challenge).
                          </Text>
                        </Box>
                        <Box>
                        ...
                        <Box>
                          ...
                          <Text fontSize={'sm'} pt={1}>
                            ...
                            originally selected, a zero-knowledge proof
                            confirming the correctness of the guess is
                            generated. Player 2 then uses this proof to verify
